...
public:
    ...
    //Citanje vrednosti registra A0
    static uint64 readA0();
    //Citanje vrednosti registra A1
    static uint64 readA1();
    //Citanje vrednosti registra A2
    static uint64 readA2();
    //Citanje vrednosti registra A3
    static uint64 readA3();
    //Citanje vrednosti registra A4
...
inline uint64 Riscv::readA3() {
    uint64  volatile a;
    __asm__ volatile ("mv %0, a3" : "=r" (a));
    return a;
}
inline uint64 Riscv::readA4() {
    uint64  volatile a;
    __asm__ volatile ("mv %0, a4" : "=r" (a));
    return a;
}
